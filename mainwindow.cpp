    ...
    , ui(new Ui::MainWindow)
{
    ...
    ui->tabela->setColumnWidth(0,100);
...
void MainWindow::on_tabela_cellDoubleClicked(int row, int column)
{
    ...
    if (column == 5){
        ...
        if (resposta == QMessageBox::Yes){
            QMessageBox::about(this, "ERRO", "Impossível alterar o valor total!");
    ...
    if (l.size()>0){
        ...
        if(ok){
            if (!txt.isEmpty()){
                ...
                QMessageBox::information(this, "ERRO", "Você não escreveu nada.");
            }
        }
    }else{
...
void MainWindow::atualizarData()
{
    ...
    inserirNaTabela(c, linha);

    atualizarEstatisticas();

    QMessageBox::about(this, "Remover", "Data alterada com sucesso.");
}
...
void MainWindow::on_actionCarregar_triggered()
{
    ...
    if (resposta== QMessageBox::No){
        ...
        if(resposta == QMessageBox::Yes){
            ...
            //QMessageBox::information(this, "Salvo com sucesso", "Você salvou o arquivo. Aperte OK para poder carregar outro.");
